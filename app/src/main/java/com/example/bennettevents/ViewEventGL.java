...
public class ViewEventGL extends AppCompatActivity {
    ListView listView;
    ArrayList<String> Events=new ArrayList<>();
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_view_event_gl);
        FirebaseDatabase database = FirebaseDatabase.getInstance();
        DatabaseReference records = database.getReference("Events/Guest Lecture");
        listView = findViewById(R.id.lvGL);
