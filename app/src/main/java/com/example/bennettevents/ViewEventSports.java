...
public class ViewEventSports extends AppCompatActivity {
    ListView listView;
    ArrayList<String> Events=new ArrayList<>();
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_view_event_sports);
        FirebaseDatabase database = FirebaseDatabase.getInstance();
        DatabaseReference records = database.getReference("Events/Sports");
        listView = findViewById(R.id.lvSport);
